...
export const grid = new contrib.grid({rows: 12, cols: 12, screen: screen})

export const bar = grid.set(5, 6, 7, 4, contrib.bar,
...
export const donut = grid.set(0, 0, 5, 2, contrib.donut,
  {
  label: 'Node Count',
  radius: 16,
  arcWidth: 4,
...
export const nodeCountLine = grid.set(0, 2, 5, 8, contrib.line,
	{ showNthLabel: 5
	, maxY: 100
...
export const map: any = grid.set(5, 0, 7, 6, contrib.map, {label: 'Regional Information'})
...
setLineData([transactionsData, transactionsData1, transactionsData2], nodeCountLine)
